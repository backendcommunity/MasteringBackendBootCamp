...
<template>
    <section class="flex flex-col items-center  py-20 px-16  gap-20 ">
        ...
        <main class="flex lg:flex-row flex-col gap-10 items-center justify-center w-full
        ">
            <div class=" flex  w-2/3 gap-10 h-fit ">
                <div class="col-span-1  w-1/2 flex flex-col gap-8 p-5 border border-black rounded-2xl bg-white py-10">
            ...
            <div
                class="col-span-1 w-1/3  flex flex-col gap-8 p-5 border border-black rounded-2xl text-white py-10  bg-gradient-to-tr to-[#322EB0] from-[#8F03A1]">
                <div class="flex flex-col gap-5">
                    <h1 class="font-semibold text-2xl">Other Courses</h1>
                    <ul class="list-disc flex flex-col gap-3 pl-5">
                        <li>Lifetime access to the course content and materials.</li>
